...
constexpr std::array registry =
{
    ...
    MessageEntry{
        ...
        {
            "Indicates BMC resource consumption by process in terms of storage, CPU and memory or any other resource",
            "HIGH %1 resource consuming process %2",
            "Warning",
            2,
            {
                "string",
    ...
    MessageEntry{
        ...
        {
            "Indicates BMC resource consumption by process in terms of storage, CPU and memory or any other resource",
            "HIGH %1 resource consuming processes %2",
            "Warning",
            2,
            {
                "string",
...
enum class Index
{
    ...
    bMCKernelPanic = 25,
    bMCRebootReason = 26,
    bMCServiceResourceInfo = 27,
    bMCSystemResourceInfo = 28,
    cPLDFirmwarePanicReason = 29,
    cPLDFirmwareRecoveryReason = 30,
    cPLDFirmwareResiliencyError = 31,
    cPUError = 32,
    cPUMismatch = 33,
    cPUThermalTrip = 34,
    chassisIntrusionDetected = 35,
    chassisIntrusionReset = 36,
    componentOverTemperature = 37,
    dCPowerOff = 38,
    dCPowerOn = 39,
    driveError = 40,
    eventLogCleared = 41,
    fanInserted = 42,
    fanRedundancyLost = 43,
    fanRedundancyRegained = 44,
    fanRemoved = 45,
    firmwareActivationCompleted = 46,
    firmwareActivationFailed = 47,
    firmwareActivationStarted = 48,
    firmwareResiliencyError = 49,
    firmwareUpdateCompleted = 50,
    firmwareUpdateFailed = 51,
    firmwareUpdateStaged = 52,
    firmwareUpdateStarted = 53,
    generalFirmwareSecurityViolation = 54,
    iPMIWatchdog = 55,
