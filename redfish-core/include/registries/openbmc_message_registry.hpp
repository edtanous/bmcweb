...
constexpr std::array registry =
{
    ...
    MessageEntry{
        "BMCSystemTimeUpdated",
        {
            "Indicates that the BMC system time has been updated.",
            "The BMC system time has been updated to %1.",
            "OK",
            1,
            {
                "string",
    ...
    MessageEntry{
        "IPCCriticalThresholdCrossed",
        {
            "Indicates that the IPC monitor has detected a service crossing the critical threshold limit set on a property",
            "DBus IPC Monitor detected %1 unit crossing critical threshold set on %2 IPC property. Property Reading=%3 Threshold=%4.",
            "Critical",
            4,
            {
                "string",
    ...
    MessageEntry{
        "IPCWarningThresholdCrossed",
        {
            "Indicates that the IPC monitor has detected a service crossing the warning threshold limit set on a property",
            "DBus IPC Monitor detected %1 unit crossing warning threshold set on %2 IPC property. Property Reading=%3 Threshold=%4.",
            "Warning",
            4,
            {
                "string",
    ...
    MessageEntry{
        "SensorCableStatusEnable",
        {
            "Indicates that a cable sensor moved from error status to enable status.",
    ...
    MessageEntry{
        "SensorCableStatusError",
        {
            "Indicates that a cable sensor moved from enable status to error status.",
    ...
    MessageEntry{
        ...
        {
            "Indicates that discrete trigger condition is met and requires immediate attention.",
            "Discrete condition '%1' of trigger '%2' is met on sensor %3, recorded value: %4, timestamp: %5",
            "Critical",
            5,
            {
                "string",
    ...
    MessageEntry{
        ...
        {
            "Indicates that discrete trigger condition is met and may require attention.",
            "Discrete condition '%1' of trigger '%2' is met on sensor %3, recorded value: %4, timestamp: %5",
            "Warning",
            5,
            {
    ...
    MessageEntry{
        ...
        {
            "Indicates that numeric trigger threshold is crossed and may require attention.",
            "Numeric threshold '%1' of trigger '%2' is crossed on sensor %3, recorded value: %4, crossing direction: %5, timestamp: %6",
            "Critical",
            6,
            {
                "string",
...
enum class Index
{
    aDDDCCorrectable = 0,
    asyncError = 1,
    atScaleDebugConnected = 2,
    atScaleDebugConnectionFailed = 3,
    atScaleDebugDisconnected = 4,
    atScaleDebugFeatureDisabled = 5,
    atScaleDebugFeatureDisabledAtHardware = 6,
    atScaleDebugFeatureEnabled = 7,
    atScaleDebugFeatureEnabledAtHardware = 8,
    atScaleDebugSpecialUserDisabled = 9,
    atScaleDebugSpecialUserEnabled = 10,
    bIOSAttributesChanged = 11,
    bIOSBoot = 12,
    bIOSFirmwarePanicReason = 13,
    bIOSFirmwareRecoveryReason = 14,
    bIOSFirmwareResiliencyError = 15,
    bIOSPOSTCode = 16,
    bIOSPOSTError = 17,
    bIOSRecoveryComplete = 18,
    bIOSRecoveryStart = 19,
    bMCBootReason = 20,
    bMCFactoryReset = 21,
    ...
    bMCLogsErased = 26,
    bMCRebootReason = 27,
    bMCServicePeakResourceInfo = 28,
    bMCServiceResourceInfo = 29,
    bMCSystemResourceInfo = 30,
    bMCSystemTimeUpdated = 31,
    cPLDFirmwarePanicReason = 32,
    cPLDFirmwareRecoveryReason = 33,
    cPLDFirmwareResiliencyError = 34,
    cPUError = 35,
    cPUMismatch = 36,
    cPUThermalTrip = 37,
    chassisIntrusionDetected = 38,
    chassisIntrusionReset = 39,
    componentOverTemperature = 40,
    dCPowerOff = 41,
    dCPowerOn = 42,
    debugTokenRequestSuccess = 43,
    debugTokenStatusSuccess = 44,
    driveError = 45,
    eventLogCleared = 46,
    fanInserted = 47,
    fanRedundancyLost = 48,
    fanRedundancyRegained = 49,
    fanRemoved = 50,
    firmwareActivationCompleted = 51,
    firmwareActivationFailed = 52,
    firmwareActivationStarted = 53,
    firmwareNotInRecovery = 54,
    firmwareResiliencyError = 55,
    firmwareUpdateCompleted = 56,
    firmwareUpdateFailed = 57,
    firmwareUpdateStaged = 58,
    firmwareUpdateStarted = 59,
    generalFirmwareSecurityViolation = 60,
    iPCCriticalThresholdCrossed = 61,
    iPCWarningThresholdCrossed = 62,
    iPMIWatchdog = 63,
    intelUPILinkWidthReducedToHalf = 64,
    intelUPILinkWidthReducedToQuarter = 65,
    invalidLoginAttempted = 66,
    invalidUpload = 67,
    inventoryAdded = 68,
    inventoryRemoved = 69,
    lanLost = 70,
    ...
    legacyPCIPERR = 72,
    legacyPCISERR = 73,
    mEAutoConfigFailed = 74,
    mEAutoConfigSuccess = 75,
    mEBootGuardHealthEvent = 76,
    mECpuDebugCapabilityDisabled = 77,
    mEDirectFlashUpdateRequested = 78,
    mEExceptionDuringShutdown = 79,
    mEFactoryResetError = 80,
    mEFactoryRestore = 81,
    mEFirmwareException = 82,
    mEFirmwarePanicReason = 83,
    mEFirmwareRecoveryReason = 84,
    mEFirmwareResiliencyError = 85,
    mEFlashEraseError = 86,
    mEFlashStateInformation = 87,
    mEFlashStateInformationWritingEnabled = 88,
    mEFlashVerificationError = 89,
    mEFlashWearOutWarning = 90,
    mEImageExecutionFailed = 91,
    mEInternalError = 92,
    mEManufacturingError = 93,
    mEMctpInterfaceError = 94,
    mEMultiPchModeMisconfig = 95,
    mEPeciOverDmiError = 96,
    mEPttHealthEvent = 97,
    mERecoveryGpioForced = 98,
    mERestrictedMode = 99,
    mESmbusLinkFailure = 100,
    mEUmaError = 101,
    mEUnsupportedFeature = 102,
    manufacturingModeEntered = 103,
    manufacturingModeExited = 104,
    memoryECCCorrectable = 105,
    memoryECCUncorrectable = 106,
    memoryParityCommandAndAddress = 107,
    memoryParityNotKnown = 108,
    memoryRASConfigurationDisabled = 109,
    memoryRASConfigurationEnabled = 110,
    memoryRASModeDisabled = 111,
    memoryRASModeEnabled = 112,
    memoryThermTrip = 113,
    mirroringRedundancyDegraded = 114,
    mirroringRedundancyFull = 115,
    nMIButtonPressed = 116,
    nMIDiagnosticInterrupt = 117,
    pCIeCorrectableAdvisoryNonFatal = 118,
    pCIeCorrectableBadDLLP = 119,
    pCIeCorrectableBadTLP = 120,
    pCIeCorrectableHeaderLogOverflow = 121,
    pCIeCorrectableInternal = 122,
    pCIeCorrectableLinkBWChanged = 123,
    pCIeCorrectableReceiverError = 124,
    pCIeCorrectableReplayNumRollover = 125,
    pCIeCorrectableReplayTimerTimeout = 126,
    pCIeCorrectableUnspecifiedAERError = 127,
    pCIeFatalACSViolation = 128,
    pCIeFatalAtomicEgressBlocked = 129,
    pCIeFatalCompleterAbort = 130,
    pCIeFatalCompletionTimeout = 131,
    pCIeFatalDataLinkLayerProtocol = 132,
    pCIeFatalECRCError = 133,
    pCIeFatalFlowControlProtocol = 134,
    pCIeFatalMCBlockedTLP = 135,
    pCIeFatalMalformedTLP = 136,
    pCIeFatalPoisonedTLP = 137,
    pCIeFatalReceivedErrNonFatalMessage = 138,
    pCIeFatalReceivedFatalMessageFromDownstream = 139,
    pCIeFatalReceiverBufferOverflow = 140,
    pCIeFatalSurpriseLinkDown = 141,
    pCIeFatalTLPPrefixBlocked = 142,
    pCIeFatalUncorrectableInternal = 143,
    pCIeFatalUnexpectedCompletion = 144,
    pCIeFatalUnspecifiedNonAERFatalError = 145,
    pCIeFatalUnsupportedRequest = 146,
    powerButtonPressed = 147,
    powerRestorePolicyApplied = 148,
    powerSupplyConfigurationError = 149,
    powerSupplyConfigurationErrorRecovered = 150,
    powerSupplyFailed = 151,
    powerSupplyFailurePredicted = 152,
    powerSupplyFanFailed = 153,
    powerSupplyFanRecovered = 154,
    powerSupplyInserted = 155,
    powerSupplyPowerGoodFailed = 156,
    powerSupplyPowerLost = 157,
    powerSupplyPowerRestored = 158,
    powerSupplyPredictedFailureRecovered = 159,
    powerSupplyRecovered = 160,
    powerSupplyRemoved = 161,
    powerUnitDegradedFromNonRedundant = 162,
    powerUnitDegradedFromRedundant = 163,
    powerUnitNonRedundantFromInsufficient = 164,
    powerUnitNonRedundantInsufficient = 165,
    powerUnitNonRedundantSufficient = 166,
    powerUnitRedundancyDegraded = 167,
    powerUnitRedundancyLost = 168,
    powerUnitRedundancyRegained = 169,
    recoveryStarted = 170,
    recoverySuccessful = 171,
    resetButtonPressed = 172,
    sELEntryAdded = 173,
    securityBoot2ndFlashEnabled = 174,
    securityP2aBridgeEnabled = 175,
    securityUartPortDebugEnabled = 176,
    securityUserNonRootUidZeroAssigned = 177,
    securityUserNonRootUidZeroRemoved = 178,
    securityUserRootDisabled = 179,
    securityUserRootEnabled = 180,
    securityUserStrongHashAlgoRestored = 181,
    securityUserUnsupportedShellEnabled = 182,
    securityUserUnsupportedShellRemoved = 183,
    securityUserWeakHashAlgoEnabled = 184,
    sensorCableStatusEnable = 185,
    sensorCableStatusError = 186,
    sensorThresholdCriticalHighGoingHigh = 187,
    sensorThresholdCriticalHighGoingLow = 188,
    sensorThresholdCriticalLowGoingHigh = 189,
    sensorThresholdCriticalLowGoingLow = 190,
    sensorThresholdWarningHighGoingHigh = 191,
    sensorThresholdWarningHighGoingLow = 192,
    sensorThresholdWarningLowGoingHigh = 193,
    sensorThresholdWarningLowGoingLow = 194,
    serviceFailure = 195,
    serviceRestartReason = 196,
    serviceStarted = 197,
    sparingRedundancyDegraded = 198,
    sparingRedundancyFull = 199,
    ssbThermalTrip = 200,
    systemInterfaceDisabledProvisioned = 201,
    systemInterfaceUnprovisioned = 202,
    systemInterfaceWhitelistProvisioned = 203,
    systemPowerGoodFailed = 204,
    systemPowerLost = 205,
    systemPowerOffFailed = 206,
    systemPowerOnFailed = 207,
    triggerDiscreteCritical = 208,
    triggerDiscreteOK = 209,
    triggerDiscreteWarning = 210,
    triggerNumericCritical = 211,
    triggerNumericWarning = 212,
    voltageRegulatorOverheated = 213,
};
} // namespace redfish::registries::openbmc
