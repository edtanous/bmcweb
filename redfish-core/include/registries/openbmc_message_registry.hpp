...
enum class Index
{
    ...
    iPMIWatchdog = 59,
    intelUPILinkWidthReducedToHalf = 60,
    intelUPILinkWidthReducedToQuarter = 61,
    invalidLoginAttempted = 62,
    invalidUpload = 63,
    inventoryAdded = 64,
    inventoryRemoved = 65,
    lanLost = 66,
    ...
    legacyPCIPERR = 68,
    legacyPCISERR = 69,
    mEAutoConfigFailed = 70,
    mEAutoConfigSuccess = 71,
    mEBootGuardHealthEvent = 72,
    mECpuDebugCapabilityDisabled = 73,
    mEDirectFlashUpdateRequested = 74,
    mEExceptionDuringShutdown = 75,
    mEFactoryResetError = 76,
    mEFactoryRestore = 77,
    mEFirmwareException = 78,
    mEFirmwarePanicReason = 79,
    mEFirmwareRecoveryReason = 80,
    mEFirmwareResiliencyError = 81,
    mEFlashEraseError = 82,
    mEFlashStateInformation = 83,
    mEFlashStateInformationWritingEnabled = 84,
    mEFlashVerificationError = 85,
    mEFlashWearOutWarning = 86,
    mEImageExecutionFailed = 87,
    mEInternalError = 88,
    mEManufacturingError = 89,
    mEMctpInterfaceError = 90,
    mEMultiPchModeMisconfig = 91,
    mEPeciOverDmiError = 92,
    mEPttHealthEvent = 93,
    mERecoveryGpioForced = 94,
    mERestrictedMode = 95,
    mESmbusLinkFailure = 96,
    mEUmaError = 97,
    mEUnsupportedFeature = 98,
    manufacturingModeEntered = 99,
    manufacturingModeExited = 100,
    memoryECCCorrectable = 101,
    memoryECCUncorrectable = 102,
    memoryParityCommandAndAddress = 103,
    memoryParityNotKnown = 104,
    memoryRASConfigurationDisabled = 105,
    memoryRASConfigurationEnabled = 106,
    memoryRASModeDisabled = 107,
    memoryRASModeEnabled = 108,
    memoryThermTrip = 109,
    mirroringRedundancyDegraded = 110,
    mirroringRedundancyFull = 111,
    nMIButtonPressed = 112,
    nMIDiagnosticInterrupt = 113,
    pCIeCorrectableAdvisoryNonFatal = 114,
    pCIeCorrectableBadDLLP = 115,
    pCIeCorrectableBadTLP = 116,
    pCIeCorrectableHeaderLogOverflow = 117,
    pCIeCorrectableInternal = 118,
    pCIeCorrectableLinkBWChanged = 119,
    pCIeCorrectableReceiverError = 120,
    pCIeCorrectableReplayNumRollover = 121,
    pCIeCorrectableReplayTimerTimeout = 122,
    pCIeCorrectableUnspecifiedAERError = 123,
    pCIeFatalACSViolation = 124,
    pCIeFatalAtomicEgressBlocked = 125,
    pCIeFatalCompleterAbort = 126,
    pCIeFatalCompletionTimeout = 127,
    pCIeFatalDataLinkLayerProtocol = 128,
    pCIeFatalECRCError = 129,
    pCIeFatalFlowControlProtocol = 130,
    pCIeFatalMCBlockedTLP = 131,
    pCIeFatalMalformedTLP = 132,
    pCIeFatalPoisonedTLP = 133,
    pCIeFatalReceivedErrNonFatalMessage = 134,
    pCIeFatalReceivedFatalMessageFromDownstream = 135,
    pCIeFatalReceiverBufferOverflow = 136,
    pCIeFatalSurpriseLinkDown = 137,
    pCIeFatalTLPPrefixBlocked = 138,
    pCIeFatalUncorrectableInternal = 139,
    pCIeFatalUnexpectedCompletion = 140,
    pCIeFatalUnspecifiedNonAERFatalError = 141,
    pCIeFatalUnsupportedRequest = 142,
    powerButtonPressed = 143,
    powerRestorePolicyApplied = 144,
    powerSupplyConfigurationError = 145,
    powerSupplyConfigurationErrorRecovered = 146,
    powerSupplyFailed = 147,
    powerSupplyFailurePredicted = 148,
    powerSupplyFanFailed = 149,
    powerSupplyFanRecovered = 150,
    powerSupplyInserted = 151,
    powerSupplyPowerGoodFailed = 152,
    powerSupplyPowerLost = 153,
    powerSupplyPowerRestored = 154,
    powerSupplyPredictedFailureRecovered = 155,
    powerSupplyRecovered = 156,
    powerSupplyRemoved = 157,
    powerUnitDegradedFromNonRedundant = 158,
    powerUnitDegradedFromRedundant = 159,
    powerUnitNonRedundantFromInsufficient = 160,
    powerUnitNonRedundantInsufficient = 161,
    powerUnitNonRedundantSufficient = 162,
    powerUnitRedundancyDegraded = 163,
    powerUnitRedundancyLost = 164,
    powerUnitRedundancyRegained = 165,
    resetButtonPressed = 166,
    sELEntryAdded = 167,
    securityBoot2ndFlashEnabled = 168,
    securityP2aBridgeEnabled = 169,
    securityUartPortDebugEnabled = 170,
    securityUserNonRootUidZeroAssigned = 171,
    securityUserNonRootUidZeroRemoved = 172,
    securityUserRootDisabled = 173,
    securityUserRootEnabled = 174,
    securityUserStrongHashAlgoRestored = 175,
    securityUserUnsupportedShellEnabled = 176,
    securityUserUnsupportedShellRemoved = 177,
    securityUserWeakHashAlgoEnabled = 178,
    sensorCableStatusEnable = 179,
    sensorCableStatusError = 180,
    sensorThresholdCriticalHighGoingHigh = 181,
    sensorThresholdCriticalHighGoingLow = 182,
    sensorThresholdCriticalLowGoingHigh = 183,
    sensorThresholdCriticalLowGoingLow = 184,
    sensorThresholdWarningHighGoingHigh = 185,
    sensorThresholdWarningHighGoingLow = 186,
    sensorThresholdWarningLowGoingHigh = 187,
    sensorThresholdWarningLowGoingLow = 188,
    serviceFailure = 189,
    serviceStarted = 190,
    sparingRedundancyDegraded = 191,
    sparingRedundancyFull = 192,
    ssbThermalTrip = 193,
    systemInterfaceDisabledProvisioned = 194,
    systemInterfaceUnprovisioned = 195,
    systemInterfaceWhitelistProvisioned = 196,
    systemPowerGoodFailed = 197,
    systemPowerLost = 198,
    systemPowerOffFailed = 199,
    systemPowerOnFailed = 200,
    triggerDiscreteCritical = 201,
    triggerDiscreteOK = 202,
    triggerDiscreteWarning = 203,
    triggerNumericCritical = 204,
    triggerNumericWarning = 205,
    voltageRegulatorOverheated = 206,
};
} // namespace redfish::registries::openbmc
