...
constexpr std::array registry = {
    ...
    MessageEntry{"TriggerDiscreteCritical",
				{
    ...
    MessageEntry{"TriggerDiscreteOK",
				{
    ...
    MessageEntry{"TriggerDiscreteWarning",
				{
    ...
    MessageEntry{"TriggerNumericCritical",
				{
    ...
    MessageEntry{"TriggerNumericWarning",
                {
    ...
    MessageEntry{
        "BMCSystemResourceInfo",
        {
            ...
            "Processes consuming HIGH %1 Resource are %2",
            "Warning",
            "Warning",
            2,
            {
