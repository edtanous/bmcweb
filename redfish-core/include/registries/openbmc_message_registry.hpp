...
enum class Index
{
    ...
    firmwareResiliencyError = 54,
    firmwareUpdateCompleted = 55,
    firmwareUpdateFailed = 56,
    firmwareUpdateStaged = 57,
    firmwareUpdateStarted = 58,
    generalFirmwareSecurityViolation = 59,
    iPCCriticalThresholdCrossed = 60,
    iPCWarningThresholdCrossed = 61,
    iPMIWatchdog = 62,
    intelUPILinkWidthReducedToHalf = 63,
    intelUPILinkWidthReducedToQuarter = 64,
    invalidLoginAttempted = 65,
    invalidUpload = 66,
    inventoryAdded = 67,
    inventoryRemoved = 68,
    lanLost = 69,
    ...
    legacyPCIPERR = 71,
    legacyPCISERR = 72,
    mEAutoConfigFailed = 73,
    mEAutoConfigSuccess = 74,
    mEBootGuardHealthEvent = 75,
    mECpuDebugCapabilityDisabled = 76,
    mEDirectFlashUpdateRequested = 77,
    mEExceptionDuringShutdown = 78,
    mEFactoryResetError = 79,
    mEFactoryRestore = 80,
    mEFirmwareException = 81,
    mEFirmwarePanicReason = 82,
    mEFirmwareRecoveryReason = 83,
    mEFirmwareResiliencyError = 84,
    mEFlashEraseError = 85,
    mEFlashStateInformation = 86,
    mEFlashStateInformationWritingEnabled = 87,
    mEFlashVerificationError = 88,
    mEFlashWearOutWarning = 89,
    mEImageExecutionFailed = 90,
    mEInternalError = 91,
    mEManufacturingError = 92,
    mEMctpInterfaceError = 93,
    mEMultiPchModeMisconfig = 94,
    mEPeciOverDmiError = 95,
    mEPttHealthEvent = 96,
    mERecoveryGpioForced = 97,
    mERestrictedMode = 98,
    mESmbusLinkFailure = 99,
    mEUmaError = 100,
    mEUnsupportedFeature = 101,
    manufacturingModeEntered = 102,
    manufacturingModeExited = 103,
    memoryECCCorrectable = 104,
    memoryECCUncorrectable = 105,
    memoryParityCommandAndAddress = 106,
    memoryParityNotKnown = 107,
    memoryRASConfigurationDisabled = 108,
    memoryRASConfigurationEnabled = 109,
    memoryRASModeDisabled = 110,
    memoryRASModeEnabled = 111,
    memoryThermTrip = 112,
    mirroringRedundancyDegraded = 113,
    mirroringRedundancyFull = 114,
    nMIButtonPressed = 115,
    nMIDiagnosticInterrupt = 116,
    pCIeCorrectableAdvisoryNonFatal = 117,
    pCIeCorrectableBadDLLP = 118,
    pCIeCorrectableBadTLP = 119,
    pCIeCorrectableHeaderLogOverflow = 120,
    pCIeCorrectableInternal = 121,
    pCIeCorrectableLinkBWChanged = 122,
    pCIeCorrectableReceiverError = 123,
    pCIeCorrectableReplayNumRollover = 124,
    pCIeCorrectableReplayTimerTimeout = 125,
    pCIeCorrectableUnspecifiedAERError = 126,
    pCIeFatalACSViolation = 127,
    pCIeFatalAtomicEgressBlocked = 128,
    pCIeFatalCompleterAbort = 129,
    pCIeFatalCompletionTimeout = 130,
    pCIeFatalDataLinkLayerProtocol = 131,
    pCIeFatalECRCError = 132,
    pCIeFatalFlowControlProtocol = 133,
    pCIeFatalMCBlockedTLP = 134,
    pCIeFatalMalformedTLP = 135,
    pCIeFatalPoisonedTLP = 136,
    pCIeFatalReceivedErrNonFatalMessage = 137,
    pCIeFatalReceivedFatalMessageFromDownstream = 138,
    pCIeFatalReceiverBufferOverflow = 139,
    pCIeFatalSurpriseLinkDown = 140,
    pCIeFatalTLPPrefixBlocked = 141,
    pCIeFatalUncorrectableInternal = 142,
    pCIeFatalUnexpectedCompletion = 143,
    pCIeFatalUnspecifiedNonAERFatalError = 144,
    pCIeFatalUnsupportedRequest = 145,
    powerButtonPressed = 146,
    powerRestorePolicyApplied = 147,
    powerSupplyConfigurationError = 148,
    powerSupplyConfigurationErrorRecovered = 149,
    powerSupplyFailed = 150,
    powerSupplyFailurePredicted = 151,
    powerSupplyFanFailed = 152,
    powerSupplyFanRecovered = 153,
    powerSupplyInserted = 154,
    powerSupplyPowerGoodFailed = 155,
    powerSupplyPowerLost = 156,
    powerSupplyPowerRestored = 157,
    powerSupplyPredictedFailureRecovered = 158,
    powerSupplyRecovered = 159,
    powerSupplyRemoved = 160,
    powerUnitDegradedFromNonRedundant = 161,
    powerUnitDegradedFromRedundant = 162,
    powerUnitNonRedundantFromInsufficient = 163,
    powerUnitNonRedundantInsufficient = 164,
    powerUnitNonRedundantSufficient = 165,
    powerUnitRedundancyDegraded = 166,
    powerUnitRedundancyLost = 167,
    powerUnitRedundancyRegained = 168,
    resetButtonPressed = 169,
    sELEntryAdded = 170,
    securityBoot2ndFlashEnabled = 171,
    securityP2aBridgeEnabled = 172,
    securityUartPortDebugEnabled = 173,
    securityUserNonRootUidZeroAssigned = 174,
    securityUserNonRootUidZeroRemoved = 175,
    securityUserRootDisabled = 176,
    securityUserRootEnabled = 177,
    securityUserStrongHashAlgoRestored = 178,
    securityUserUnsupportedShellEnabled = 179,
    securityUserUnsupportedShellRemoved = 180,
    securityUserWeakHashAlgoEnabled = 181,
    sensorCableStatusEnable = 182,
    sensorCableStatusError = 183,
    sensorThresholdCriticalHighGoingHigh = 184,
    sensorThresholdCriticalHighGoingLow = 185,
    sensorThresholdCriticalLowGoingHigh = 186,
    sensorThresholdCriticalLowGoingLow = 187,
    sensorThresholdWarningHighGoingHigh = 188,
    sensorThresholdWarningHighGoingLow = 189,
    sensorThresholdWarningLowGoingHigh = 190,
    sensorThresholdWarningLowGoingLow = 191,
    serviceFailure = 192,
    serviceRestartReason = 193,
    serviceStarted = 194,
    sparingRedundancyDegraded = 195,
    sparingRedundancyFull = 196,
    ssbThermalTrip = 197,
    systemInterfaceDisabledProvisioned = 198,
    systemInterfaceUnprovisioned = 199,
    systemInterfaceWhitelistProvisioned = 200,
    systemPowerGoodFailed = 201,
    systemPowerLost = 202,
    systemPowerOffFailed = 203,
    systemPowerOnFailed = 204,
    triggerDiscreteCritical = 205,
    triggerDiscreteOK = 206,
    triggerDiscreteWarning = 207,
    triggerNumericCritical = 208,
    triggerNumericWarning = 209,
    voltageRegulatorOverheated = 210,
};
} // namespace redfish::registries::openbmc
