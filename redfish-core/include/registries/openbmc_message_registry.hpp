...
enum class Index
{
    ...
    cPLDFirmwarePanicReason = 31,
    cPLDFirmwareRecoveryReason = 32,
    cPLDFirmwareResiliencyError = 33,
    cPUError = 34,
    cPUMismatch = 35,
    cPUThermalTrip = 36,
    chassisIntrusionDetected = 37,
    chassisIntrusionReset = 38,
    componentOverTemperature = 39,
    dCPowerOff = 40,
    dCPowerOn = 41,
    debugTokenRequestSuccess = 42,
    debugTokenStatusSuccess = 43,
    driveError = 44,
    eventLogCleared = 45,
    fanInserted = 46,
    fanRedundancyLost = 47,
    fanRedundancyRegained = 48,
    fanRemoved = 49,
    firmwareActivationCompleted = 50,
    firmwareActivationFailed = 51,
    firmwareActivationStarted = 52,
    firmwareResiliencyError = 53,
    firmwareUpdateCompleted = 54,
    firmwareUpdateFailed = 55,
    firmwareUpdateStaged = 56,
    firmwareUpdateStarted = 57,
    generalFirmwareSecurityViolation = 58,
    iPCCriticalThresholdCrossed = 59,
    iPCWarningThresholdCrossed = 60,
    iPMIWatchdog = 61,
    intelUPILinkWidthReducedToHalf = 62,
    intelUPILinkWidthReducedToQuarter = 63,
    invalidLoginAttempted = 64,
    invalidUpload = 65,
    inventoryAdded = 66,
    inventoryRemoved = 67,
    lanLost = 68,
    ...
    legacyPCIPERR = 70,
    legacyPCISERR = 71,
    mEAutoConfigFailed = 72,
    mEAutoConfigSuccess = 73,
    mEBootGuardHealthEvent = 74,
    mECpuDebugCapabilityDisabled = 75,
    mEDirectFlashUpdateRequested = 76,
    mEExceptionDuringShutdown = 77,
    mEFactoryResetError = 78,
    mEFactoryRestore = 79,
    mEFirmwareException = 80,
    mEFirmwarePanicReason = 81,
    mEFirmwareRecoveryReason = 82,
    mEFirmwareResiliencyError = 83,
    mEFlashEraseError = 84,
    mEFlashStateInformation = 85,
    mEFlashStateInformationWritingEnabled = 86,
    mEFlashVerificationError = 87,
    mEFlashWearOutWarning = 88,
    mEImageExecutionFailed = 89,
    mEInternalError = 90,
    mEManufacturingError = 91,
    mEMctpInterfaceError = 92,
    mEMultiPchModeMisconfig = 93,
    mEPeciOverDmiError = 94,
    mEPttHealthEvent = 95,
    mERecoveryGpioForced = 96,
    mERestrictedMode = 97,
    mESmbusLinkFailure = 98,
    mEUmaError = 99,
    mEUnsupportedFeature = 100,
    manufacturingModeEntered = 101,
    manufacturingModeExited = 102,
    memoryECCCorrectable = 103,
    memoryECCUncorrectable = 104,
    memoryParityCommandAndAddress = 105,
    memoryParityNotKnown = 106,
    memoryRASConfigurationDisabled = 107,
    memoryRASConfigurationEnabled = 108,
    memoryRASModeDisabled = 109,
    memoryRASModeEnabled = 110,
    memoryThermTrip = 111,
    mirroringRedundancyDegraded = 112,
    mirroringRedundancyFull = 113,
    nMIButtonPressed = 114,
    nMIDiagnosticInterrupt = 115,
    pCIeCorrectableAdvisoryNonFatal = 116,
    pCIeCorrectableBadDLLP = 117,
    pCIeCorrectableBadTLP = 118,
    pCIeCorrectableHeaderLogOverflow = 119,
    pCIeCorrectableInternal = 120,
    pCIeCorrectableLinkBWChanged = 121,
    pCIeCorrectableReceiverError = 122,
    pCIeCorrectableReplayNumRollover = 123,
    pCIeCorrectableReplayTimerTimeout = 124,
    pCIeCorrectableUnspecifiedAERError = 125,
    pCIeFatalACSViolation = 126,
    pCIeFatalAtomicEgressBlocked = 127,
    pCIeFatalCompleterAbort = 128,
    pCIeFatalCompletionTimeout = 129,
    pCIeFatalDataLinkLayerProtocol = 130,
    pCIeFatalECRCError = 131,
    pCIeFatalFlowControlProtocol = 132,
    pCIeFatalMCBlockedTLP = 133,
    pCIeFatalMalformedTLP = 134,
    pCIeFatalPoisonedTLP = 135,
    pCIeFatalReceivedErrNonFatalMessage = 136,
    pCIeFatalReceivedFatalMessageFromDownstream = 137,
    pCIeFatalReceiverBufferOverflow = 138,
    pCIeFatalSurpriseLinkDown = 139,
    pCIeFatalTLPPrefixBlocked = 140,
    pCIeFatalUncorrectableInternal = 141,
    pCIeFatalUnexpectedCompletion = 142,
    pCIeFatalUnspecifiedNonAERFatalError = 143,
    pCIeFatalUnsupportedRequest = 144,
    powerButtonPressed = 145,
    powerRestorePolicyApplied = 146,
    powerSupplyConfigurationError = 147,
    powerSupplyConfigurationErrorRecovered = 148,
    powerSupplyFailed = 149,
    powerSupplyFailurePredicted = 150,
    powerSupplyFanFailed = 151,
    powerSupplyFanRecovered = 152,
    powerSupplyInserted = 153,
    powerSupplyPowerGoodFailed = 154,
    powerSupplyPowerLost = 155,
    powerSupplyPowerRestored = 156,
    powerSupplyPredictedFailureRecovered = 157,
    powerSupplyRecovered = 158,
    powerSupplyRemoved = 159,
    powerUnitDegradedFromNonRedundant = 160,
    powerUnitDegradedFromRedundant = 161,
    powerUnitNonRedundantFromInsufficient = 162,
    powerUnitNonRedundantInsufficient = 163,
    powerUnitNonRedundantSufficient = 164,
    powerUnitRedundancyDegraded = 165,
    powerUnitRedundancyLost = 166,
    powerUnitRedundancyRegained = 167,
    resetButtonPressed = 168,
    sELEntryAdded = 169,
    securityBoot2ndFlashEnabled = 170,
    securityP2aBridgeEnabled = 171,
    securityUartPortDebugEnabled = 172,
    securityUserNonRootUidZeroAssigned = 173,
    securityUserNonRootUidZeroRemoved = 174,
    securityUserRootDisabled = 175,
    securityUserRootEnabled = 176,
    securityUserStrongHashAlgoRestored = 177,
    securityUserUnsupportedShellEnabled = 178,
    securityUserUnsupportedShellRemoved = 179,
    securityUserWeakHashAlgoEnabled = 180,
    sensorCableStatusEnable = 181,
    sensorCableStatusError = 182,
    sensorThresholdCriticalHighGoingHigh = 183,
    sensorThresholdCriticalHighGoingLow = 184,
    sensorThresholdCriticalLowGoingHigh = 185,
    sensorThresholdCriticalLowGoingLow = 186,
    sensorThresholdWarningHighGoingHigh = 187,
    sensorThresholdWarningHighGoingLow = 188,
    ...
    ssbThermalTrip = 196,
    systemInterfaceDisabledProvisioned = 197,
    systemInterfaceUnprovisioned = 198,
    systemInterfaceWhitelistProvisioned = 199,
    systemPowerGoodFailed = 200,
    systemPowerLost = 201,
    systemPowerOffFailed = 202,
    systemPowerOnFailed = 203,
    triggerDiscreteCritical = 204,
    triggerDiscreteOK = 205,
    triggerDiscreteWarning = 206,
    triggerNumericCritical = 207,
    triggerNumericWarning = 208,
    voltageRegulatorOverheated = 209,
};
} // namespace redfish::registries::openbmc
