...
enum class Index
{
    ...
    eventLogCleared = 43,
    fanInserted = 44,
    fanRedundancyLost = 45,
    fanRedundancyRegained = 46,
    fanRemoved = 47,
    firmwareActivationCompleted = 48,
    firmwareActivationFailed = 49,
    firmwareActivationStarted = 50,
    firmwareResiliencyError = 51,
    firmwareUpdateCompleted = 52,
    firmwareUpdateFailed = 53,
    firmwareUpdateStaged = 54,
    firmwareUpdateStarted = 55,
    generalFirmwareSecurityViolation = 56,
    iPMIWatchdog = 57,
    intelUPILinkWidthReducedToHalf = 58,
    intelUPILinkWidthReducedToQuarter = 59,
    invalidLoginAttempted = 60,
    invalidUpload = 61,
    inventoryAdded = 62,
    inventoryRemoved = 63,
    lanLost = 64,
    ...
    legacyPCIPERR = 66,
    legacyPCISERR = 67,
    mEAutoConfigFailed = 68,
    mEAutoConfigSuccess = 69,
    mEBootGuardHealthEvent = 70,
    mECpuDebugCapabilityDisabled = 71,
    mEDirectFlashUpdateRequested = 72,
    mEExceptionDuringShutdown = 73,
    mEFactoryResetError = 74,
    mEFactoryRestore = 75,
    mEFirmwareException = 76,
    mEFirmwarePanicReason = 77,
    mEFirmwareRecoveryReason = 78,
    mEFirmwareResiliencyError = 79,
    mEFlashEraseError = 80,
    mEFlashStateInformation = 81,
    mEFlashStateInformationWritingEnabled = 82,
    mEFlashVerificationError = 83,
    mEFlashWearOutWarning = 84,
    mEImageExecutionFailed = 85,
    mEInternalError = 86,
    mEManufacturingError = 87,
    mEMctpInterfaceError = 88,
    mEMultiPchModeMisconfig = 89,
    mEPeciOverDmiError = 90,
    mEPttHealthEvent = 91,
    mERecoveryGpioForced = 92,
    mERestrictedMode = 93,
    mESmbusLinkFailure = 94,
    mEUmaError = 95,
    mEUnsupportedFeature = 96,
    manufacturingModeEntered = 97,
    manufacturingModeExited = 98,
    memoryECCCorrectable = 99,
    memoryECCUncorrectable = 100,
    memoryParityCommandAndAddress = 101,
    memoryParityNotKnown = 102,
    memoryRASConfigurationDisabled = 103,
    memoryRASConfigurationEnabled = 104,
    memoryRASModeDisabled = 105,
    memoryRASModeEnabled = 106,
    memoryThermTrip = 107,
    mirroringRedundancyDegraded = 108,
    mirroringRedundancyFull = 109,
    nMIButtonPressed = 110,
    nMIDiagnosticInterrupt = 111,
    pCIeCorrectableAdvisoryNonFatal = 112,
    pCIeCorrectableBadDLLP = 113,
    pCIeCorrectableBadTLP = 114,
    pCIeCorrectableHeaderLogOverflow = 115,
    pCIeCorrectableInternal = 116,
    pCIeCorrectableLinkBWChanged = 117,
    pCIeCorrectableReceiverError = 118,
    pCIeCorrectableReplayNumRollover = 119,
    pCIeCorrectableReplayTimerTimeout = 120,
    pCIeCorrectableUnspecifiedAERError = 121,
    pCIeFatalACSViolation = 122,
    pCIeFatalAtomicEgressBlocked = 123,
    pCIeFatalCompleterAbort = 124,
    pCIeFatalCompletionTimeout = 125,
    pCIeFatalDataLinkLayerProtocol = 126,
    pCIeFatalECRCError = 127,
    pCIeFatalFlowControlProtocol = 128,
    pCIeFatalMCBlockedTLP = 129,
    pCIeFatalMalformedTLP = 130,
    pCIeFatalPoisonedTLP = 131,
    pCIeFatalReceivedErrNonFatalMessage = 132,
    pCIeFatalReceivedFatalMessageFromDownstream = 133,
    pCIeFatalReceiverBufferOverflow = 134,
    pCIeFatalSurpriseLinkDown = 135,
    pCIeFatalTLPPrefixBlocked = 136,
    pCIeFatalUncorrectableInternal = 137,
    pCIeFatalUnexpectedCompletion = 138,
    pCIeFatalUnspecifiedNonAERFatalError = 139,
    pCIeFatalUnsupportedRequest = 140,
    powerButtonPressed = 141,
    powerRestorePolicyApplied = 142,
    powerSupplyConfigurationError = 143,
    powerSupplyConfigurationErrorRecovered = 144,
    powerSupplyFailed = 145,
    powerSupplyFailurePredicted = 146,
    powerSupplyFanFailed = 147,
    powerSupplyFanRecovered = 148,
    powerSupplyInserted = 149,
    powerSupplyPowerGoodFailed = 150,
    powerSupplyPowerLost = 151,
    powerSupplyPowerRestored = 152,
    powerSupplyPredictedFailureRecovered = 153,
    powerSupplyRecovered = 154,
    powerSupplyRemoved = 155,
    powerUnitDegradedFromNonRedundant = 156,
    powerUnitDegradedFromRedundant = 157,
    powerUnitNonRedundantFromInsufficient = 158,
    powerUnitNonRedundantInsufficient = 159,
    powerUnitNonRedundantSufficient = 160,
    powerUnitRedundancyDegraded = 161,
    powerUnitRedundancyLost = 162,
    powerUnitRedundancyRegained = 163,
    resetButtonPressed = 164,
    sELEntryAdded = 165,
    securityBoot2ndFlashEnabled = 166,
    securityP2aBridgeEnabled = 167,
    securityUartPortDebugEnabled = 168,
    securityUserNonRootUidZeroAssigned = 169,
    securityUserNonRootUidZeroRemoved = 170,
    securityUserRootDisabled = 171,
    securityUserRootEnabled = 172,
    securityUserStrongHashAlgoRestored = 173,
    securityUserUnsupportedShellEnabled = 174,
    securityUserUnsupportedShellRemoved = 175,
    securityUserWeakHashAlgoEnabled = 176,
    sensorCableStatusEnable = 177,
    sensorCableStatusError = 178,
    sensorThresholdCriticalHighGoingHigh = 179,
    sensorThresholdCriticalHighGoingLow = 180,
    sensorThresholdCriticalLowGoingHigh = 181,
    sensorThresholdCriticalLowGoingLow = 182,
    sensorThresholdWarningHighGoingHigh = 183,
    sensorThresholdWarningHighGoingLow = 184,
    sensorThresholdWarningLowGoingHigh = 185,
    sensorThresholdWarningLowGoingLow = 186,
    serviceFailure = 187,
    serviceStarted = 188,
    sparingRedundancyDegraded = 189,
    sparingRedundancyFull = 190,
    ssbThermalTrip = 191,
    systemInterfaceDisabledProvisioned = 192,
    systemInterfaceUnprovisioned = 193,
    systemInterfaceWhitelistProvisioned = 194,
    systemPowerGoodFailed = 195,
    systemPowerLost = 196,
    systemPowerOffFailed = 197,
    systemPowerOnFailed = 198,
    triggerDiscreteCritical = 199,
    triggerDiscreteOK = 200,
    triggerDiscreteWarning = 201,
    triggerNumericCritical = 202,
    triggerNumericWarning = 203,
    voltageRegulatorOverheated = 204,
};
} // namespace redfish::registries::openbmc
