...
enum class Index
{
    ...
    eventLogCleared = 44,
    fanInserted = 45,
    fanRedundancyLost = 46,
    fanRedundancyRegained = 47,
    fanRemoved = 48,
    firmwareActivationCompleted = 49,
    firmwareActivationFailed = 50,
    firmwareActivationStarted = 51,
    firmwareResiliencyError = 52,
    firmwareUpdateCompleted = 53,
    firmwareUpdateFailed = 54,
    firmwareUpdateStaged = 55,
    firmwareUpdateStarted = 56,
    generalFirmwareSecurityViolation = 57,
    iPCCriticalThresholdCrossed = 58,
    iPCWarningThresholdCrossed = 59,
    iPMIWatchdog = 60,
    intelUPILinkWidthReducedToHalf = 61,
    intelUPILinkWidthReducedToQuarter = 62,
    invalidLoginAttempted = 63,
    invalidUpload = 64,
    inventoryAdded = 65,
    inventoryRemoved = 66,
    lanLost = 67,
    ...
    legacyPCIPERR = 69,
    legacyPCISERR = 70,
    mEAutoConfigFailed = 71,
    mEAutoConfigSuccess = 72,
    mEBootGuardHealthEvent = 73,
    mECpuDebugCapabilityDisabled = 74,
    mEDirectFlashUpdateRequested = 75,
    mEExceptionDuringShutdown = 76,
    mEFactoryResetError = 77,
    mEFactoryRestore = 78,
    mEFirmwareException = 79,
    mEFirmwarePanicReason = 80,
    mEFirmwareRecoveryReason = 81,
    mEFirmwareResiliencyError = 82,
    mEFlashEraseError = 83,
    mEFlashStateInformation = 84,
    mEFlashStateInformationWritingEnabled = 85,
    mEFlashVerificationError = 86,
    mEFlashWearOutWarning = 87,
    mEImageExecutionFailed = 88,
    mEInternalError = 89,
    mEManufacturingError = 90,
    mEMctpInterfaceError = 91,
    mEMultiPchModeMisconfig = 92,
    mEPeciOverDmiError = 93,
    mEPttHealthEvent = 94,
    mERecoveryGpioForced = 95,
    mERestrictedMode = 96,
    mESmbusLinkFailure = 97,
    mEUmaError = 98,
    mEUnsupportedFeature = 99,
    manufacturingModeEntered = 100,
    manufacturingModeExited = 101,
    memoryECCCorrectable = 102,
    memoryECCUncorrectable = 103,
    memoryParityCommandAndAddress = 104,
    memoryParityNotKnown = 105,
    memoryRASConfigurationDisabled = 106,
    memoryRASConfigurationEnabled = 107,
    memoryRASModeDisabled = 108,
    memoryRASModeEnabled = 109,
    memoryThermTrip = 110,
    mirroringRedundancyDegraded = 111,
    mirroringRedundancyFull = 112,
    nMIButtonPressed = 113,
    nMIDiagnosticInterrupt = 114,
    pCIeCorrectableAdvisoryNonFatal = 115,
    pCIeCorrectableBadDLLP = 116,
    pCIeCorrectableBadTLP = 117,
    pCIeCorrectableHeaderLogOverflow = 118,
    pCIeCorrectableInternal = 119,
    pCIeCorrectableLinkBWChanged = 120,
    pCIeCorrectableReceiverError = 121,
    pCIeCorrectableReplayNumRollover = 122,
    pCIeCorrectableReplayTimerTimeout = 123,
    pCIeCorrectableUnspecifiedAERError = 124,
    pCIeFatalACSViolation = 125,
    pCIeFatalAtomicEgressBlocked = 126,
    pCIeFatalCompleterAbort = 127,
    pCIeFatalCompletionTimeout = 128,
    pCIeFatalDataLinkLayerProtocol = 129,
    pCIeFatalECRCError = 130,
    pCIeFatalFlowControlProtocol = 131,
    pCIeFatalMCBlockedTLP = 132,
    pCIeFatalMalformedTLP = 133,
    pCIeFatalPoisonedTLP = 134,
    pCIeFatalReceivedErrNonFatalMessage = 135,
    pCIeFatalReceivedFatalMessageFromDownstream = 136,
    pCIeFatalReceiverBufferOverflow = 137,
    pCIeFatalSurpriseLinkDown = 138,
    pCIeFatalTLPPrefixBlocked = 139,
    pCIeFatalUncorrectableInternal = 140,
    pCIeFatalUnexpectedCompletion = 141,
    pCIeFatalUnspecifiedNonAERFatalError = 142,
    pCIeFatalUnsupportedRequest = 143,
    powerButtonPressed = 144,
    powerRestorePolicyApplied = 145,
    powerSupplyConfigurationError = 146,
    powerSupplyConfigurationErrorRecovered = 147,
    powerSupplyFailed = 148,
    powerSupplyFailurePredicted = 149,
    powerSupplyFanFailed = 150,
    powerSupplyFanRecovered = 151,
    powerSupplyInserted = 152,
    powerSupplyPowerGoodFailed = 153,
    powerSupplyPowerLost = 154,
    powerSupplyPowerRestored = 155,
    powerSupplyPredictedFailureRecovered = 156,
    powerSupplyRecovered = 157,
    powerSupplyRemoved = 158,
    powerUnitDegradedFromNonRedundant = 159,
    powerUnitDegradedFromRedundant = 160,
    powerUnitNonRedundantFromInsufficient = 161,
    powerUnitNonRedundantInsufficient = 162,
    powerUnitNonRedundantSufficient = 163,
    powerUnitRedundancyDegraded = 164,
    powerUnitRedundancyLost = 165,
    powerUnitRedundancyRegained = 166,
    resetButtonPressed = 167,
    sELEntryAdded = 168,
    securityBoot2ndFlashEnabled = 169,
    securityP2aBridgeEnabled = 170,
    securityUartPortDebugEnabled = 171,
    securityUserNonRootUidZeroAssigned = 172,
    securityUserNonRootUidZeroRemoved = 173,
    securityUserRootDisabled = 174,
    securityUserRootEnabled = 175,
    securityUserStrongHashAlgoRestored = 176,
    securityUserUnsupportedShellEnabled = 177,
    securityUserUnsupportedShellRemoved = 178,
    securityUserWeakHashAlgoEnabled = 179,
    sensorCableStatusEnable = 180,
    sensorCableStatusError = 181,
    sensorThresholdCriticalHighGoingHigh = 182,
    sensorThresholdCriticalHighGoingLow = 183,
    sensorThresholdCriticalLowGoingHigh = 184,
    sensorThresholdCriticalLowGoingLow = 185,
    sensorThresholdWarningHighGoingHigh = 186,
    sensorThresholdWarningHighGoingLow = 187,
    sensorThresholdWarningLowGoingHigh = 188,
    sensorThresholdWarningLowGoingLow = 189,
    serviceFailure = 190,
    serviceRestartReason = 191,
    serviceStarted = 192,
    sparingRedundancyDegraded = 193,
    sparingRedundancyFull = 194,
    ssbThermalTrip = 195,
    systemInterfaceDisabledProvisioned = 196,
    systemInterfaceUnprovisioned = 197,
    systemInterfaceWhitelistProvisioned = 198,
    systemPowerGoodFailed = 199,
    systemPowerLost = 200,
    systemPowerOffFailed = 201,
    systemPowerOnFailed = 202,
    triggerDiscreteCritical = 203,
    triggerDiscreteOK = 204,
    triggerDiscreteWarning = 205,
    triggerNumericCritical = 206,
    triggerNumericWarning = 207,
    voltageRegulatorOverheated = 208,
};
} // namespace redfish::registries::openbmc
