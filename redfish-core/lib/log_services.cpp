...
static int getJournalMetadata(sd_journal* journal, std::string_view field,
...
void fillHostLoggerEntryJson(const std::string& logEntryID,
 ...
 */
static bool parsePostCode(const std::string& postCodeID, uint64_t& currentValue,
                          uint16_t& index)
{
