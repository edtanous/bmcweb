 ...
 */
std::string getTransferProtocolTypeFromUri(const std::string& imageUri)
{
 ...
 */
void vmParseInterfaceObject(const dbus::utility::DBusInterfacesMap& interfaces,
                            const std::shared_ptr<bmcweb::AsyncResp>& asyncResp)
{
 ...
 */
nlohmann::json vmItemTemplate(const std::string& name,
                              const std::string& resName)
{
    nlohmann::json item;
 ...
 */
void getVmResourceList(std::shared_ptr<bmcweb::AsyncResp> asyncResp,
...
void afterGetVmData(const std::string& name, const std::string& /*service*/,
                    const std::string& resName,
                    const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
                    const std::pair<sdbusplus::message::object_path,
 ...
 */
void getVmData(const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
               const std::string& service, const std::string& name,
               const std::string& resName)
{
 ...
 *
 */
void validateParams(const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
 ...
 * All BMC state properties will be retrieved before sending reset request.
 */
void doEjectAction(const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
                   const std::string& service, const std::string& name,
                   bool legacy)
{
...
void handleManagersVirtualMediaActionInsertPost(
...
void handleManagersVirtualMediaActionEject(
    crow::App& app, const crow::Request& req,
    const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
...
void handleManagersVirtualMediaCollectionGet(
    crow::App& app, const crow::Request& req,
    const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
...
void handleVirtualMediaGet(crow::App& app, const crow::Request& req,
                           const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
                           const std::string& name, const std::string& resName)
{
    if (!redfish::setUpRedfishRoute(app, req, asyncResp))
