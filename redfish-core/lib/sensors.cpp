...
sensor::ReadingType toReadingType(std::string_view sensorType)
{
...
std::string_view toReadingUnits(std::string_view sensorType)
{
    if (sensorType == "voltage")
    {
        return "V";
 ...
 *
 * */
void populateChassisNode(nlohmann::json& jsonValue,
 ...
 */
std::string getState(const InventoryItem* inventoryItem)
{
 ...
 */
std::string getHealth(nlohmann::json& sensorJson,
...
void setLedState(nlohmann::json& sensorJson, const InventoryItem* inventoryItem)
{
...
void sortJSONResponse(const std::shared_ptr<SensorsAsyncResp>& sensorsAsyncResp)
{
 ...
 */
InventoryItem* findInventoryItem(
 ...
 */
nlohmann::json& getPowerSupply(nlohmann::json& powerSupplyArray,
                               const InventoryItem& inventoryItem,
 ...
 */
bool findSensorNameUsingSensorPath(std::string_view sensorName,
...
void handleSensorCollectionGet(
