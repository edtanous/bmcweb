...
void handleAdapterError(const boost::system::error_code& ec,
                        crow::Response& res, const std::string& adapterId)
{
...
void getFabricAdapterAsset(const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
...
void getFabricAdapterState(const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
                           const std::string& serviceName,
                           const std::string& fabricAdapterPath)
{
...
void getFabricAdapterHealth(const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
                            const std::string& serviceName,
                            const std::string& fabricAdapterPath)
{
    sdbusplus::asio::getProperty<bool>(
...
void doAdapterGet(const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
...
bool checkFabricAdapterId(const std::string& adapterPath,
...
void getValidFabricAdapterPath(
...
void handleFabricAdapterGet(App& app, const crow::Request& req,
                            const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
...
void handleFabricAdapterCollectionGet(
...
void handleFabricAdapterCollectionHead(
    crow::App& app, const crow::Request& req,
    const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
    const std::string& systemName)
{
...
void requestRoutesFabricAdapterCollection(App& app)
{
...
void requestRoutesFabricAdapters(App& app)
{
