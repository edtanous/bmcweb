 ...
 */
void getProcessorUUID(std::shared_ptr<bmcweb::AsyncResp> asyncResp,
...
void getCpuDataByService(std::shared_ptr<bmcweb::AsyncResp> asyncResp,
 ...
 */
processor::ThrottleCause dbusToRfThrottleCause(const std::string& dbusSource)
{
    if (dbusSource ==
...
void readThrottleProperties(const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
                            const boost::system::error_code& ec,
...
void getThrottleProperties(const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
...
void getCpuAssetData(std::shared_ptr<bmcweb::AsyncResp> asyncResp,
                     const std::string& service, const std::string& objPath)
{
...
void getCpuRevisionData(std::shared_ptr<bmcweb::AsyncResp> asyncResp,
                        const std::string& service, const std::string& objPath)
{
...
void getAcceleratorDataByService(std::shared_ptr<bmcweb::AsyncResp> asyncResp,
 ...
 * @param[in]       objPath     D-Bus object to query.
 */
void getCpuConfigData(const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
                      const std::string& cpuId, const std::string& service,
                      const std::string& objPath)
{
 ...
 * @param[in]       objPath     D-Bus object to query.
 */
void getCpuLocationCode(std::shared_ptr<bmcweb::AsyncResp> asyncResp,
                        const std::string& service, const std::string& objPath)
{
 ...
 * @param[in]       objPath     D-Bus object to query.
 */
void getCpuUniqueId(const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
...
void getProcessorObject(const std::shared_ptr<bmcweb::AsyncResp>& resp,
...
void getProcessorData(const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
 ...
 * @param[in]       objPath     D-Bus object to query.
 */
void getOperatingConfigData(const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
                            const std::string& service,
                            const std::string& objPath)
{
    sdbusplus::asio::getAllProperties(
 ...
 */
void handleAppliedConfigResponse(const std::shared_ptr<bmcweb::AsyncResp>& resp,
 ...
 */
void patchAppliedOperatingConfig(
...
void handleProcessorHead(crow::App& app, const crow::Request& req,
                         const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
