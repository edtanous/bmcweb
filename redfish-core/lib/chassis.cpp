 ...
 * @return None.
 */
void getStorageLink(const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
 ...
 * @return None.
 */
void getChassisState(std::shared_ptr<bmcweb::AsyncResp> asyncResp)
{
 ...
 */
void handlePhysicalSecurityGetSubTree(
...
void getChassisConnectivity(const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
...
void getChassisLocationCode(const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
...
void getChassisUUID(const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
 ...
 */
void handleChassisPowerCycleError(const boost::system::error_code& ec,
