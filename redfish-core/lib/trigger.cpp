...
triggers::TriggerActionEnum toRedfishTriggerAction(std::string_view dbusValue)
{
    if (dbusValue ==
...
std::string toDbusTriggerAction(std::string_view redfishValue)
{
...
std::string toDbusSeverity(std::string_view redfishValue)
{
    if (redfishValue == "OK")
    {
...
resource::Health toRedfishSeverity(std::string_view dbusValue)
{
...
std::string toDbusThresholdName(std::string_view redfishValue)
{
...
std::string toRedfishThresholdName(std::string_view dbusValue)
{
...
std::string toDbusActivation(std::string_view redfishValue)
{
...
triggers::ThresholdActivation toRedfishActivation(std::string_view dbusValue)
{
...
std::optional<MetricType> getMetricType(const std::string& metricType)
{
...
bool parseNumericThresholds(crow::Response& res,
                            nlohmann::json& numericThresholds, Context& ctx)
{
...
bool parseLinks(crow::Response& res, nlohmann::json& links, Context& ctx)
{
    if (links.empty())
    {
        return true;
...
bool parseMetricProperties(crow::Response& res, Context& ctx)
{
...
bool parsePostTriggerParams(crow::Response& res, const crow::Request& req,
                            Context& ctx)
{
...
void afterCreateTrigger(const boost::system::error_code& ec,
...
std::optional<nlohmann::json::array_t>
...
std::optional<nlohmann::json> getMetricReportDefinitions(
...
void handleTriggerCollectionPost(
