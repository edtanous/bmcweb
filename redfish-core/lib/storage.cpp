...
void handleSystemsStorageCollectionGet(
...
void handleStorageCollectionGet(
    App& app, const crow::Request& req,
    const std::shared_ptr<bmcweb::AsyncResp>& asyncResp)
{
    if (!redfish::setUpRedfishRoute(app, req, asyncResp))
...
void afterChassisDriveCollectionSubtree(
    const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
...
void getDrives(const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
               const std::shared_ptr<HealthPopulate>& health)
{
...
void afterSystemsStorageGetSubtree(
    const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
...
void afterSubtree(const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
...
void handleStorageGet(App& app, const crow::Request& req,
                      const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
                      const std::string& storageId)
{
    if (!redfish::setUpRedfishRoute(app, req, asyncResp))
...
void getDriveAsset(const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
...
void getDrivePresent(const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
                     const std::string& connectionName, const std::string& path)
{
...
void getDriveState(const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
                   const std::string& connectionName, const std::string& path)
{
    sdbusplus::asio::getProperty<bool>(
        *crow::connections::systemBus, connectionName, path,
...
std::optional<drive::MediaType> convertDriveType(std::string_view type)
{
...
std::optional<protocol::Protocol> convertDriveProtocol(std::string_view proto)
{
...
void getDriveItemProperties(const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
...
void handleSystemsStorageDriveGet(
    App& app, const crow::Request& req,
    const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
...
void afterChassisDriveCollectionSubtreeGet(
    const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
...
void getStorageControllerAsset(
    const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
    const boost::system::error_code& ec,
...
void getStorageControllerHandler(
    const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
...
void populateStorageControllerCollection(
    const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
    const boost::system::error_code& ec,
...
void handleSystemsStorageControllerCollectionGet(
    App& app, const crow::Request& req,
    const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
    const std::string& systemName)
{
...
void handleSystemsStorageControllerGet(
    App& app, const crow::Request& req,
    const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
