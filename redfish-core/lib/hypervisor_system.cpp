 ...
 * @return None.
 */
void getHypervisorState(const std::shared_ptr<bmcweb::AsyncResp>& asyncResp)
{
 ...
 * @return None.
 */
void getHypervisorActions(const std::shared_ptr<bmcweb::AsyncResp>& asyncResp)
{
 ...
 * @return None
 */
void createHypervisorIPv4(const std::string& ifaceId, uint8_t prefixLength,
                          const std::string& gateway,
                          const std::string& address,
                          const std::shared_ptr<bmcweb::AsyncResp>& asyncResp)
{
 ...
 * @return None
 */
void deleteHypervisorIPv4(const std::string& ifaceId,
                          const std::shared_ptr<bmcweb::AsyncResp>& asyncResp)
{
...
void setDHCPEnabled(const std::string& ifaceId, bool ipv4DHCPEnabled,
                    const std::shared_ptr<bmcweb::AsyncResp>& asyncResp)
{
...
void handleHypervisorHostnamePatch(
    const std::string& hostName,
    const std::shared_ptr<bmcweb::AsyncResp>& asyncResp)
{
...
void handleHypervisorEthernetInterfaceCollectionGet(
...
void handleHypervisorEthernetInterfaceGet(
    App& app, const crow::Request& req,
