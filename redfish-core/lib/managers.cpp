...
const dbus::utility::ManagedObjectType::value_type*
 ...
 * @return none
 */
void getLocation(const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
 ...
 * @return void
 */
void setActiveFirmwareImage(const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
...
void afterSetDateTime(const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
                      const boost::system::error_code& ec,
...
void setDateTime(const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
...
void checkForQuiesced(const std::shared_ptr<bmcweb::AsyncResp>& asyncResp)
{
    sdbusplus::asio::getProperty<std::string>(
