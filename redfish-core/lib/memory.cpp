...
void dimmPropToHex(const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
...
void assembleDimmProperties(std::string_view dimmId,
                            const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
                            const dbus::utility::DBusPropertiesMap& properties,
                            const nlohmann::json::json_pointer& jsonPtr)
{
...
void getDimmDataByService(std::shared_ptr<bmcweb::AsyncResp> asyncResp,
...
void assembleDimmPartitionData(
    const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
    const dbus::utility::DBusPropertiesMap& properties,
...
void getDimmPartitionData(std::shared_ptr<bmcweb::AsyncResp> asyncResp,
...
void getDimmData(std::shared_ptr<bmcweb::AsyncResp> asyncResp,
