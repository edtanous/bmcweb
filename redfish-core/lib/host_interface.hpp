        ...
        .methods(boost::beast::http::verb::get)(
            [](const crow::Request&,
               ...
               const std::string& ifaceId) {
                ...
                asyncResp->res
                    .jsonValue["Links"]["ComputerSystems@odata.count"] = 1;
            ...
            [](const crow::Request& req,
               ...
               const std::string& ifaceId) {
                ...
                if (credentialBootstrap)
                {
                    ...
                    if (!json_util::readJson(*credentialBootstrap,
                                             asyncResp->res, "EnableAfterReset",
                                             enableAfterReset, "Enabled",
                                             enabled))
                    {
                        BMCWEB_LOG_ERROR
                            << "Invalid CredentialBootstrapping object";
                        asyncResp->res.result(
                            boost::beast::http::status::bad_request);
                        return;
                    }
