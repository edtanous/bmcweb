...
bool verifyCommonErrors(crow::Response& res, const std::string& id,
...
metric_report_definition::ReportActionsEnum
...
std::string toDbusReportAction(std::string_view redfishValue)
{
...
std::string toDbusReportingType(std::string_view redfishValue)
{
...
std::string toDbusCollectionTimeScope(std::string_view redfishValue)
{
...
metric_report_definition::ReportUpdatesEnum
...
std::string toDbusReportUpdates(std::string_view redfishValue)
{
...
std::optional<nlohmann::json::array_t> getLinkedTriggers(
...
void fillReportDefinition(const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
                          const std::string& id,
...
bool toDbusReportActions(crow::Response& res,
...
bool getUserMetric(crow::Response& res, nlohmann::json& metric,
...
bool getUserMetrics(crow::Response& res, std::span<nlohmann::json> metrics,
...
bool getChassisSensorNodeFromMetrics(
...
void setReportEnabled(const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
...
void setReportUpdates(const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
...
void setReportActions(const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
                      std::string_view id,
...
void setReportMetrics(const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
...
void handleMetricReportDefinitionCollectionHead(
...
void handleReportPatch(App& app, const crow::Request& req,
                       const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
                       std::string_view id)
{
    if (!redfish::setUpRedfishRoute(app, req, asyncResp))
...
void handleReportDelete(App& app, const crow::Request& req,
                        const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
                        std::string_view id)
{
    if (!redfish::setUpRedfishRoute(app, req, asyncResp))
...
void afterRetrieveUriToDbusMap(
    const std::shared_ptr<bmcweb::AsyncResp>& /*asyncResp*/,
...
void handleMetricReportHead(App& app, const crow::Request& req,
                            const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
                            const std::string& /*id*/)
{
    if (!redfish::setUpRedfishRoute(app, req, asyncResp))
