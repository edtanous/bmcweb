 ...
 * @return None.
 */
void updateDimmProperties(const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
 ...
 * @return None.
 */
void modifyCpuPresenceState(const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
                            bool isCpuPresent)
{
 ...
 * @return None.
 */
void getProcessorSummary(const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
 ...
 */
std::string dbusToRfBootSource(const std::string& dbusSource)
{
 ...
 * cannot be done, returns an empty string.
 */
std::string dbusToRfBootType(const std::string& dbusType)
{
 ...
 * cannot be done, returns an empty string.
 */
std::string dbusToRfBootMode(const std::string& dbusMode)
{
 ...
 */
std::string dbusToRfBootProgress(const std::string& dbusBootProgress)
{
 ...
 */
int assignBootParameters(const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
...
void getBootOverrideMode(const std::shared_ptr<bmcweb::AsyncResp>& asyncResp)
{
    sdbusplus::asio::getProperty<std::string>(
        *crow::connections::systemBus, "xyz.openbmc_project.Settings",
        "/xyz/openbmc_project/control/host0/boot",
...
void processBootOverrideEnable(
    const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
...
void getBootOverrideEnable(const std::shared_ptr<bmcweb::AsyncResp>& asyncResp)
{
    sdbusplus::asio::getProperty<bool>(
        *crow::connections::systemBus, "xyz.openbmc_project.Settings",
        "/xyz/openbmc_project/control/host0/boot",
...
void setBootProperties(const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
                       const std::optional<std::string>& bootSource,
                       const std::optional<std::string>& bootType,
                       const std::optional<std::string>& bootEnable)
{
 ...
 * @return None.
 */
void getProvisioningStatus(std::shared_ptr<bmcweb::AsyncResp> asyncResp)
{
...
void afterGetPowerMode(const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
                       const boost::system::error_code& ec,
                       const dbus::utility::DBusPropertiesMap& properties)
{
    if (ec)
 ...
 */
std::string dbusToRfWatchdogAction(const std::string& dbusAction)
{
...
std::string rfToDbusWDTTimeOutAct(const std::string& rfAction)
{
    if (rfAction == "None")
    {
 ...
 */
bool parseIpsProperties(const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
                        const dbus::utility::DBusPropertiesMap& properties)
{
    const bool* enabled = nullptr;
...
void handleComputerSystemResetActionPost(
    crow::App& app, const crow::Request& req,
    const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
...
void handleComputerSystemPatch(
    crow::App& app, const crow::Request& req,
    const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
    const std::string& systemName)
{
 ...
 * allowableValues.
 */
void dbusToRfAllowedHostTransitions(const std::string& dbusAllowedHostTran,
