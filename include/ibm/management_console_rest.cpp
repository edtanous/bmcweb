...
void handleFilePut(const crow::Request& req,
...
void handleConfigFileList(const std::shared_ptr<bmcweb::AsyncResp>& asyncResp)
{
...
void deleteConfigFiles(const std::shared_ptr<bmcweb::AsyncResp>& asyncResp)
{
    std::error_code ec;
    std::filesystem::path loc(
        "/var/lib/bmcweb/ibm-management-console/configfiles");
...
void getLockServiceData(const std::shared_ptr<bmcweb::AsyncResp>& asyncResp)
{
...
void handleFileGet(const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
                   const std::string& fileID)
{
...
void handleFileDelete(const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
                      const std::string& fileID)
{
...
void handleBroadcastService(const crow::Request& req,
                            const std::shared_ptr<bmcweb::AsyncResp>& asyncResp)
{
...
void handleFileUrl(const crow::Request& req,
                   const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
                   const std::string& fileID)
{
...
void handleAcquireLockAPI(const crow::Request& req,
                          const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
...
void handleRelaseAllAPI(const crow::Request& req,
                        const std::shared_ptr<bmcweb::AsyncResp>& asyncResp)
{
...
void handleReleaseLockAPI(const crow::Request& req,
                          const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
...
void handleGetLockListAPI(const std::shared_ptr<bmcweb::AsyncResp>& asyncResp,
